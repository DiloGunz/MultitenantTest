...
public class GloblalExceptionHandlingMiddleware : IMiddleware
{
    ...
    public GloblalExceptionHandlingMiddleware(ILogger<GloblalExceptionHandlingMiddleware> logger) => _logger = logger ?? throw new ArgumentNullException(nameof(logger));
